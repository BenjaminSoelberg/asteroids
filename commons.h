...
#define ROM_TO_MEM(addr) ((addr - 0x0800 + 0x1000) / 2)
// Offsets below are all relative to the start of VECMEM
#define SHIP0      ROM_TO_MEM(0x0A90)
#define SHIP1      ROM_TO_MEM(0x0AA8)
#define SHIP2      ROM_TO_MEM(0x0ACC)
#define SHIP3      ROM_TO_MEM(0x0AF0)
#define SHIP4      ROM_TO_MEM(0x0B14)
#define SHIP5      ROM_TO_MEM(0x0B36)
#define SHIP6      ROM_TO_MEM(0x0B5A)
#define SHIP7      ROM_TO_MEM(0x0B7E)
#define SHIP8      ROM_TO_MEM(0x0BA2)
#define SHIP9      ROM_TO_MEM(0x0BC6)
#define SHIP10     ROM_TO_MEM(0x0BEA)
#define SHIP11     ROM_TO_MEM(0x0C0E)
#define SHIP12     ROM_TO_MEM(0x0C32)
#define SHIP13     ROM_TO_MEM(0x0C56)
#define SHIP14     ROM_TO_MEM(0x0C7A)
#define SHIP15     ROM_TO_MEM(0x0C9E)
#define SHIP16     ROM_TO_MEM(0x0CC2)
#define SHIP17     ROM_TO_MEM(0x0CDA)

#define CHAR_SPACE ROM_TO_MEM(0x0E58)
#define CHAR_0     ROM_TO_MEM(0x0DBA)
#define CHAR_1     ROM_TO_MEM(0x0E5C)
#define CHAR_2     ROM_TO_MEM(0x0E64)
#define CHAR_3     ROM_TO_MEM(0x0E74)
#define CHAR_4     ROM_TO_MEM(0x0E82)
#define CHAR_5     ROM_TO_MEM(0x0E90)
#define CHAR_6     ROM_TO_MEM(0x0E9E)
#define CHAR_7     ROM_TO_MEM(0x0EAC)
#define CHAR_8     ROM_TO_MEM(0x0EB6)
#define CHAR_9     ROM_TO_MEM(0x0EC6)
#define CHAR_A     ROM_TO_MEM(0x0CF0)
#define CHAR_B     ROM_TO_MEM(0x0D00)
#define CHAR_C     ROM_TO_MEM(0x0D1A)
#define CHAR_D     ROM_TO_MEM(0x0D26)
#define CHAR_E     ROM_TO_MEM(0x0D36)
#define CHAR_F     ROM_TO_MEM(0x0D46)
#define CHAR_G     ROM_TO_MEM(0x0D54)
#define CHAR_H     ROM_TO_MEM(0x0D66)
#define CHAR_I     ROM_TO_MEM(0x0D74)
#define CHAR_J     ROM_TO_MEM(0x0D82)
#define CHAR_K     ROM_TO_MEM(0x0D8E)
#define CHAR_L     ROM_TO_MEM(0x0D9A)
#define CHAR_M     ROM_TO_MEM(0x0DA4)
#define CHAR_N     ROM_TO_MEM(0x0DB0)
#define CHAR_O     ROM_TO_MEM(0x0DBA)
#define CHAR_P     ROM_TO_MEM(0x0DC6)
#define CHAR_Q     ROM_TO_MEM(0x0DD4)
#define CHAR_R     ROM_TO_MEM(0x0DE6)
#define CHAR_S     ROM_TO_MEM(0x0DF6)
#define CHAR_T     ROM_TO_MEM(0x0E04)
#define CHAR_U     ROM_TO_MEM(0x0E10)
#define CHAR_V     ROM_TO_MEM(0x0E1C)
#define CHAR_W     ROM_TO_MEM(0x0E26)
#define CHAR_X     ROM_TO_MEM(0x0E34)
#define CHAR_Y     ROM_TO_MEM(0x0E3E)
#define CHAR_Z     ROM_TO_MEM(0x0E4C)
